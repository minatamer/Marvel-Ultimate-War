...
public class ChooseLeaderPlayerTwo extends JFrame implements ActionListener {
	...
	public ChooseLeaderPlayerTwo(Player playerOne , Player playerTwo, Clip clip) {
		this.clip=clip;
		...
		chooser  = new JLabel();
		chooser.setText(playerTwo.getName() + " should choose only one leader");
	...
	public void actionPerformed(ActionEvent e) {
        ...
        Champion champ = playerTwo.getTeam().get(champIndex);
        int answer;
        ...
        if(answer==0) {
        	playerTwo.setLeader(champ);
     		this.dispose();
     		clip.stop();
     		try {
				ShowGame showgame = new ShowGame(playerOne , playerTwo);
